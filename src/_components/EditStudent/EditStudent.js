...
class EditStudent extends Component {
    ...
    componentDidMount(){
      ...
      this.props.students.forEach((stud,index)=>{
        if(stud.rollNo==this.props.match.params.id){
          this.props.setEditStudent(stud);
        }
      })
      // this.props.student.rollNo
    }

    saveStudent=()=>{
        this.props.updateStudent(this.props.match.params.id,this.props.student);
      }
    formChanged=(event)=>{
...
const mapDispatchToProps=dispatch=>{
    return {
      ...
      setEditStudent:(student)=>dispatch({
        type:'SETCURRENT',
        student:student
      }),
      updateStudent:(rollNo,student)=>dispatch({
        type:'UPDATESTUDENT',
        student:student,
        rollNo:rollNo
      })
